[![Go Report Card](https://goreportcard.com/badge/github.com/Chief-Alchemist/bybit)](https://goreportcard.com/report/github.com/Chief-Alchemist/bybit)
[![golangci-lint](https://github.com/Chief-Alchemist/bybit/actions/workflows/golangci-lint.yml/badge.svg)](https://github.com/Chief-Alchemist/bybit/actions/workflows/golangci-lint.yml)
[![test](https://github.com/Chief-Alchemist/bybit/actions/workflows/test.yml/badge.svg)](https://github.com/Chief-Alchemist/bybit/actions/workflows/test.yml)
...
```golang
import "github.com/Chief-Alchemist/bybit/v2"
...
I would like to cover Bybit API and contributions are always welcome. The calling pattern is established, so adding new methods is relatively straightforward. See some PRs like https://github.com/Chief-Alchemist/bybit/pull/44.
